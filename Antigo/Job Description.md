...
Required Skills:
AWS/Azure/GCP, CI/CD (Jenkins, GitHub Actions, GitLab CI/CD), Docker, Kubernetes, Linux
Administration, Shell Scripting, Application Security (AppSec), Vulnerability Management, OWASP Top 10,
Security Testing (SAST/DAST), Container Security, Cloud Security, Identity & Access Management (IAM),
Secrets Management, Terraform, CloudFormation (Good to Have), SonarQube, Snyk, Trivy, OWASP ZAP,
Checkmarx, Veracode, Aqua Security, Prisma Cloud, ELK Stack, Grafana, Prometheus, CloudWatch.
...
Mandatory Skills: DevSecOps | AWS | Azure | GCP | Jenkins | GitHub Actions | GitLab CI/CD | Docker |
Kubernetes | Terraform | SonarQube | Snyk | Trivy | OWASP | IAM | Cloud Security | Container Security |
Linux | CI/CD | Vulnerability Management.
